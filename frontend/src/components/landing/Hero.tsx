      ...
      <Container>
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
            Create QR codes online for payments, websites, WhatsApp chats, WiFi access, business
            contacts, email, SMS, phone calls, maps, and plain text. No signup required — generate,
            preview, and download your QR code instantly.
          </p>
